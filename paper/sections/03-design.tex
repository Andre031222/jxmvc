...
same fifteen-stage sequence, so cross-cutting concerns---sanitisation,
CORS, rate limiting, authentication, validation, compression,
metrics---are applied uniformly and by construction. The principal
stages, in order, are:
...
All subsystems are built in-framework. Data access (\texttt{JxDB})
