...
public class HomeController extends BaseController {
    ...
    public ActionResult about() {
        model.setVar("title",     "About · JxMVC 3.1.1");
        model.setVar("framework", "Lightning-X MVC 3.1.1 (JxMVC)");
